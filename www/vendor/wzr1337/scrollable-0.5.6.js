  ...
  IScroll.prototype = {
    ...
    _initIndicators: function() {
      ...
      function _indicatorsMap(fn) {
        var len = that.indicators ? that.indicators.length : 0;
        for (var i = len; i--;) {
    ...
    _initSnap: function() {
      ...
      this.on('refresh', function() {
        ...
        } else if (this.pages[this.currentPage.pageX] && this.pages[this.currentPage.pageY]) {
    ...
    goToPage: function(x, y, time, easing) {
      ...
      if (y >= this.pages[x] ? this.pages[x].length : 0) {
        y = this.pages[x] ? (this.pages[x].length - 1) : 0;
      } else if (y < 0) {
        y = 0;
      }

      var posX = this.pages[x] ? this.pages[x][y].x : 0,
        posY = this.pages[x] ? this.pages[x][y].y : 0;
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        var handleScrollEnd = function() {
          $timeout(function() {
            ...
            if (angular.isDefined(scope.isMinY)) {
              scope.isMinY = (iScrollInstance && iScrollInstance.y >= 0);
            }
        ...
        var _init = function() {
          ...
          for (var onMethod in scope) {
            if ((onMethod.indexOf('on') !== -1) &&
              ...
              if (event === 'scrollMove') {
                ...
                iScrollInstance.on("scroll", function(e) {
          ...
          /*
          	Emit iscroll instance to view
          */
          scope.$emit('iScrollInstance', iScrollInstance);
          ...
          element.bind('$destroy', function() {
            if (angular.isDefined(iScrollInstance) && iScrollInstance) {
              initing = false;
              iScrollInstance.destroy();
              iScrollInstance = null;
              delete iScrollInstance;
        ...
        attrs.$observe('parameters', function(val) {
          ...
          var hasScrollY = scroller.children();
          scope.$watchCollection(function() {
              hasScrollY = scroller.children();
              return scroller.outerHeight();
            },
                ...
                if (scope.shouldDestroy == 'true') {
                  ...
                  $timeout(function() {
                    ...
                    if (angular.isDefined(iScrollInstance.pages) &&
                      ...
                      scrollToPageX(hasScrollY.currPageX);
                      scrollToPageY(hasScrollY.currPageY);
